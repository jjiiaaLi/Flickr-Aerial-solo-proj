...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert("Photos", [
      ...
      {
        source:
          "https://photographycourse.net/wp-content/uploads/2020/04/small-scale-aerial-photograph.png",
        userId: 1,
        tagId: 1,
        caption: "Gorge Outflow",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        source:
          "https://allthatsinteresting.com/wordpress/wp-content/uploads/2013/09/aerial-photography-fort-bourtange-netherlands.jpg",
        userId: 1,
        tagId: 3,
        caption: "Netherland Star Fort",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
    ]);
